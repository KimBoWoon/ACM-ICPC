...
// 스티커는 대각선으로만 뜯을 수 있다
// 그러므로 dp[윗쪽 스티커][i열번 째 스티커] = max(dp[윗쪽 스티커][i열번 째 스티커], dp[아랫쪽 스티커][i - 1열번 째 스티커] + arr[윗쪽 스티커][i열번 째 스티커])
// dp[아랫쪽 스티커][i열번 째 스티커] = max(dp[아랫쪽 스티커][i열번 째 스티커], dp[윗쪽 스티커][i - 1열번 째 스티커] + arr[아래쪽 스티커][i열번 째 스티커])